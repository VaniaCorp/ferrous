...
export default function Info() {
  return (
    <div id="info" className="w-full h-screen py-[24em] flex flex-col gap-12">
      ...
      <article className="w-full max-w-lg h-max max-h-96 overflow-y-auto pr-4 flex flex-col gap-8">
        <p>
